...
export function AllExecutions({ onNavigate }) {
    ...
    return (_jsxs(Page, { title: "Ran Jobs", description: "View all job execution history", actions: _jsxs("div", { className: "flex gap-2 items-center", children: [_jsx(Select, { value: statusFilter, onChange: (value) => setStatusFilter(value), options: statusOptions, style: { marginBottom: 0 } }), _jsx(Button, { variant: "primary", onClick: refresh, children: "Refresh" })] }), children: [error && (_jsx(Alert, { variant: "error", title: "Error loading executions", children: error.message })), _jsxs(Card, { children: [_jsx(DataTable, { columns: [
                            ...
                            },
                            {
                                ...
                                label: 'Job Name',
                                sortable: true,
                                render: (value) => (_jsx("span", { role: "button", tabIndex: 0, style: { cursor: 'pointer' }, className: "font-medium text-blue-600 dark:text-blue-400 hover:underline", onClick: () => navigate(`/admin/jobs/${encodeURIComponent(String(value))}`), onKeyDown: (e) => {
                        ...
                        })), emptyMessage: "No job executions found. Jobs will appear here after they run.", loading: loading, searchable: true, exportable: true, showColumnVisibility: true, total: total, ...serverTable.dataTable, searchDebounceMs: 400 }), total > 0 && (_jsxs("div", { className: "mt-4 text-sm text-gray-500", children: ["Showing ", executions.length, " of ", total, " executions"] }))] })] }));
}
