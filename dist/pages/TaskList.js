...
export function TaskList({ onNavigate }) {
    ...
    return (_jsxs(Page, { title: "Tasks", description: "Manage and monitor task executions", actions: _jsx(Button, { variant: "primary", onClick: refresh, children: "Refresh" }), children: [error && (_jsx(Alert, { variant: "error", title: "Error loading tasks", children: error.message })), _jsx(Card, { children: _jsx(DataTable, { columns: [
                        {
                            key: 'name',
                            label: 'Name',
                            sortable: true,
                    ...
                    })), emptyMessage: "No tasks found", loading: loading, searchable: true, exportable: true, showColumnVisibility: true }) })] }));
}
